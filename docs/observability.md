...
| **Task Status Distribution (1h)**      | Пирог: сколько SUCCESS / FAILED / PENDING за час            | Быстрый health-check                                                     |
...
| Панель                                   | Что трекает                                                    | Зачем                                      |
| ---------------------------------------- | -------------------------------------------------------------- | ------------------------------------------ |
| **Intent Distribution (1h)**             | Пирог намерений (greeting / help / agile_question / ...)       | Понять, что именно спрашивают пользователи |
| **Query Type Distribution (1h)**         | Пирог типов запроса (sql / rag / hybrid / simple / error)      | Куда роутится трафик                       |
...
| Панель                                | Что трекает                                                                 | Зачем                                          |
| ------------------------------------- | --------------------------------------------------------------------------- | ---------------------------------------------- |
| **L1: TopicGuard Results (1h)**       | Пирог исходов первого слоя (passed / off_topic_blocked / injection_blocked) | Сколько запросов отсеивается на входе          |
...
| **Evaluation Outcomes (1h)**             | Пирог исходов оценок за час                                                                                                 | Быстрый снапшот: судья работает или сыпется |
