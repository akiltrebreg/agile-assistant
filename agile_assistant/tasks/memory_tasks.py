...
from agile_assistant.metrics import MEMORY_PROFILE_UPDATES, MEMORY_SUMMARIZATIONS
...
@celery_app.task(name="agile_assistant.tasks.summarize_session")
...
@celery_app.task(name="agile_assistant.tasks.update_profile_async")
