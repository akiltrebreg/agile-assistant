...
from agile_assistant.observability.logging import setup_logging
...
def _short_name(task_name: str | None) -> str:
    ...
    ``agile_assistant.tasks.execute_workflow`` -> ``execute_workflow``.
...
def create_celery_app() -> Celery:
    ...
    celery_app = Celery(
        ...
        include=[
            "agile_assistant.tasks.workflow_task",
            "agile_assistant.tasks.memory_tasks",
            ...
            "agile_assistant.tasks.judge_task",
            ...
            "agile_assistant.tasks.sync_tasks",
        ],
    )
