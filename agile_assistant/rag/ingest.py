...
Usage:
    python -m agile_assistant.rag.ingest          # default: knowledge_base/
    python -m agile_assistant.rag.ingest /path     # custom directory
"""
...
from agile_assistant.rag.embeddings import (
    get_embeddings,
    get_target_dim,
    truncate_vectors,
)
from agile_assistant.rag.sparse import embed_sparse_batch
