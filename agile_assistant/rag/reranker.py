...
from agile_assistant.metrics import RAG_CHUNKS_AFTER_RERANKER, RAG_RERANKER_DURATION
from agile_assistant.rag.embeddings import _HF_SNAPSHOT_MARKER, _download_model_from_s3
from agile_assistant.tracing import langfuse_context, observe
...
def ensure_reranker_model_downloaded() -> str:
    ...
    Mirrors :func:`agile_assistant.rag.embeddings.ensure_embedding_model_downloaded`:
