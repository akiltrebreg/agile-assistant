...
from agile_assistant.observability.logging import setup_logging as _setup_logging
...
def setup_logging() -> None:
    ...
    :func:`agile_assistant.observability.logging.setup_logging`, which
...
def main(query: str | None = None) -> None:
    ...
    if query is None:
        if len(sys.argv) < 2:
            print("Usage: python -m agile_assistant.main '<your query>'")
            print("Example: python -m agile_assistant.main 'Выведи данные по задаче ABC-123'")
            sys.exit(1)
