...
from agile_assistant.agents.schema_loader import get_schema_compact
from agile_assistant.agents.sql_tools import SQL_TOOLS, set_db
...
def _extract_results(state: AgentState) -> dict:
    ...
    if successful_sqls:
        from agile_assistant.agents.sql_tools import _get_db  # noqa: PLC0415
